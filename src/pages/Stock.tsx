...
const Stock = () => {
  ...
  const alertCount = stockItems.filter((i) => i.estado !== "ok").length;
              ...
              {filtered.map((item) => {
                ...
                return (
                  <tr key={item.id} className="border-b last:border-0 hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right font-mono text-muted-foreground">{item.minimo.toLocaleString()}</td>
